        ...
        <div className="mb-4">
          {saveState === 'saving' && (
            <div className="flex items-center gap-2 text-sm text-blue-700 bg-blue-50 border border-blue-200 rounded-lg px-4 py-3">
              ...
              Salvando esta comparação no histórico…
            </div>
          )}
          {saveState === 'saved' && (
            <div className="flex flex-wrap items-center justify-between gap-2 text-sm text-green-800 bg-green-50 border border-green-200 rounded-lg px-4 py-3">
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4" /> Comparação salva no seu histórico.</span>
          ...
          {saveState === 'error' && (
            <div className="flex items-start gap-2 text-sm text-amber-800 bg-amber-50 border border-amber-200 rounded-lg px-4 py-3">
              ...
              <span>A comparação foi concluída, mas não foi salva: {saveError}</span>
            </div>
          )}
        </div>
      )}
