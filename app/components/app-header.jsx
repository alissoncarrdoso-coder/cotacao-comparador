import { Download, LogOut, TrendingDown } from 'lucide-react'

export default function AppHeader({ hasComparison, onReset, onExport, showLogout }) {
  return (
    <header className="bg-white border-b border-slate-200 sticky top-0 z-10 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {showLogout && <form action="/api/auth/logout" method="post">
            <button
              type="submit"
              title="Sair"
              aria-label="Sair"
